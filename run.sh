...
${target}-gcc -ffreestanding -nostdlib -g -T ../linker.ld start.o kernel.o module_kernel.o module_terminal.o module_serial.o module_base.o module_interrupt.o module_interrupt_asm.o module_heap.o -lgcc -o my_kernel.elf &&
