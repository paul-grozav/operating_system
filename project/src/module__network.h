...
{
  //! ARP request
  module__network__ethernet__arp_operation_type__request = 1,

  //! ARP response
  module__network__ethernet__arp_operation_type__response = 2
};
// -------------------------------------------------------------------------- //
...
typedef struct __attribute__((__packed__))
{
   ...
   * See: module__network__ethernet__ip__protocol_type .
   */
  uint8_t protocol;
  ...
  uint8_t data[];
} module__network__ip_header;
// -------------------------------------------------------------------------- //
//! Based on: https://en.wikipedia.org/wiki/List_of_IP_protocol_numbers
enum module__network__ethernet__ip__protocol_type
{
  //! Internet Control Message Protocol
  module__network__ethernet__ip__protocol_type__icmp = 1,

  //! Transmission Control Protocol
  module__network__ethernet__ip__protocol_type__tcp = 6,
