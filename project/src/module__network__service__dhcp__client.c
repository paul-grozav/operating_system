...
{
  {
    ...
    eh->ethertype = module__network__data__ethernet_header_type__ip_v4;
    ...
    iph->header_checksum = 0; // populated later ?
    ...
    udph->source_port = 68;
    udph->destination_port = 67;
    udph->length = 0; // populated later ?
    udph->checksum = 0; // populated later ?
    ...
    bph->gateway_hops = 0;
    bph->transaction_id = 0x89cdf841; // ??? does it matter?
    ...
    bph->client_hardware_address = interface->mac_address;
