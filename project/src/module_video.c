...
void drawrect_fill(int left,int top, int right, int bottom, uint8_t color)
{
...
//  vga_clear(RGB_TO_332(0xA0,0xA0,0xA0)); // already does flip
  ...
  // one pixel
  putpixel(1, 30, RGB_TO_332(0xFF,0x0,0x0));

  // line
  vga_line(5, 5, 20, 20, RGB_TO_332(0xA0,0xA0,0xA0));

  // one rectangle -- not working?
  //vga_rect(1, 1, 20, 20, RGB_TO_332(0x0A,0xA0,0xA0));
  ...
  {
    uint8_t x = 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'G'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'R'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'A'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'p'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'h'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'i'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 'c'); x+= 20;
    vga_putchar(x, 20, RGB_TO_332(0xA0,0xA0,0xA0), RGB_TO_332(0x13,0x13,0x13), 's');
  }
